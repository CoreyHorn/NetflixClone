...
val fakeNetworkMovieResponse = listOf(
    NetworkMovie(
        ...
        categories = listOf(Category.Movies)
    ),
    NetworkMovie(
        "Inception",
    ...
    NetworkMovie(
        ...
        categories = listOf(Category.BecauseYouWatched),
        isNetflixOnly = true
    ),
    NetworkMovie(
        "Scream VI",
    ...
    NetworkMovie(
        ...
        categories = listOf(Category.TvShows, Category.BecauseYouWatched),
        isNetflixOnly = true
    ),
    NetworkMovie(
        "Superman & Lois",
        "https://image.tmdb.org/t/p/original/vlv1gn98GqMnKHLSh0dNciqGfBl.jpg",
        categories = listOf(Category.Movies, Category.BecauseYouWatched)
    ),
    NetworkMovie(
        "Ted Lasso",
    ...
    NetworkMovie(
        ...
        categories = listOf(Category.TrendingNow)
    ),
    NetworkMovie(
    ...
    NetworkMovie(
        ...
        categories = listOf(Category.NewReleases, Category.TvShows)
    ),
    NetworkMovie(
    ...
    NetworkMovie(
        ...
        categories = listOf(Category.PopularOnNetflix)
    ),
    NetworkMovie(
        "Kindred", "https://image.tmdb.org/t/p/original/iSrPT4PQmrVDGdp55cCShrpBMlj.jpg",
        categories = listOf(Category.CasualViewing)
    ),
    NetworkMovie(
    ...
    NetworkMovie(
        ...
        categories = listOf(Category.TvShows, Category.PopularOnNetflix)
    ),
    NetworkMovie(
        "Extraordinary",
    ...
    NetworkMovie(
        ...
        categories = listOf(Category.Documentaries)
    ),
    NetworkMovie(
    ...
    NetworkMovie(
        ...
        categories = listOf(Category.Movies, Category.PopularOnNetflix),
        percentFinished = .99f
    ),
    NetworkMovie("The Menu", "https://image.tmdb.org/t/p/original/1L8suifzjMrJ3DxApr8yAQRWrDB.jpg",
        categories = listOf(Category.TvShows, Category.PopularOnNetflix)),
    NetworkMovie(
        "Triangle of Sadness",
    ...
    NetworkMovie("Aftersun", "https://image.tmdb.org/t/p/original/jeXmhP2zbUkREMRqFOYIwQOk49T.jpg",
        categories = listOf(Category.CasualViewing)),
    NetworkMovie(
        "You",
        "https://image.tmdb.org/t/p/original/aqNj9RgcMjicLfm1LGpmDY7UEiM.jpg",
        categories = listOf(Category.TvShows, Category.TrendingNow),
        isNetflixOnly = true
    ),
    NetworkMovie(
        "Wednesday",
    ...
    NetworkMovie(
        ...
        categories = listOf(Category.Movies, Category.Documentaries)
    ),
    NetworkMovie(
        "Attack on Titan",
